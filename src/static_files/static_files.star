...
# helix config
HELIX_CONFIG_DIRPATH = "/helix-relay-config"
...
# bolt-boost config
BOLT_BOOST_CONFIG_DIRPATH = "/bolt-boost-config"
BOLT_BOOST_CONFIG_FULL_DIRPATH = (
    STATIC_FILES_DIRPATH + BOLT_BOOST_CONFIG_DIRPATH
)
BOLT_BOOST_CONFIG_TEMPLATE_FILEPATH = (
    STATIC_FILES_DIRPATH + BOLT_BOOST_CONFIG_DIRPATH + "/cb-bolt-boost-config.toml.tmpl"
)
