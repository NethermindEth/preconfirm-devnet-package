# Taiko on L1
taiko_on_l1 = import_module("./protocols/taiko_on_l1.star")

# Taiko SetDcapParams
set_dcap_params = import_module("./protocols/set_dcap_params.star")

# Taiko SetAddress
set_address = import_module("./protocols/set_address.star")

# Preconf DeployEigenlayerMVP
deploy_eigenlayer_mvp = import_module("../preconf-avs/protocols/deploy_eigenlayer_mvp.star")

# Preconf DeployAVS
deploy_avs = import_module("../preconf-avs/protocols/deploy_avs.star")

# Taiko SetSequencer
set_sequencer = import_module("./protocols/set_sequencer.star")
