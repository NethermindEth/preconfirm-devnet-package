...
DEFAULT_COMMIT_BOOST_MEV_BOOST_IMAGE = "chainbound/bolt-boost:v0.3.0-alpha"
...
ETHEREUM_GENESIS_GENERATOR = struct(
    ...
    deneb_genesis="ethpandaops/ethereum-genesis-generator:master",  # Customised for Taiko Preconf
