...
def input_parser(plan, input_args):
    ...
    return struct(
        ...
        contracts_addresses=struct(
            ...
            l1_bridge=result["contracts_addresses"]["l1_bridge"],
            l2_bridge=result["contracts_addresses"]["l2_bridge"],
            l1_signal_service=result["contracts_addresses"]["l1_signal_service"],
            l2_signal_service=result["contracts_addresses"]["l2_signal_service"],
            l1_erc20_vault=result["contracts_addresses"]["l1_erc20_vault"],
            l2_erc20_vault=result["contracts_addresses"]["l2_erc20_vault"],
            l1_erc721_vault=result["contracts_addresses"]["l1_erc721_vault"],
            l2_erc721_vault=result["contracts_addresses"]["l2_erc721_vault"],
            l1_erc1155_vault=result["contracts_addresses"]["l1_erc1155_vault"],
            l2_erc1155_vault=result["contracts_addresses"]["l2_erc1155_vault"],
        ),
        dora_params=struct(
